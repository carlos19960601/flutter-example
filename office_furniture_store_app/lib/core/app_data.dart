...
import 'package:office_furniture_store_app/core/app_asset.dart';
import 'package:office_furniture_store_app/models/furniture.dart';
import 'package:office_furniture_store_app/models/furniture_color.dart';
...
class AppData {
  ...
  static List<BottomNavigationBarItem> bottomNavigationItems = [
    ...
    const BottomNavigationBarItem(
        icon: Icon(Icons.add_shopping_cart_rounded), label: 'Shopping cart'),
    const BottomNavigationBarItem(
